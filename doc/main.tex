...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=1\linewidth]{IFML - Navigation.png}
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.9\linewidth]{IFML - Document Move.png}
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.9\linewidth]{IFML - Subfolder Creation.png}
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.9\linewidth]{IFML - Document Creation.png}
    \end{figure}
\end{frame}
